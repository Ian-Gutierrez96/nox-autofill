export const argentineProvinces = new Map([
  ["B", "Buenos Aires"],
  ["K", "Catamarca"],
  ["H", "Chaco"],
  ["U", "Chubut"],
...
export const armenianRegions = new Map([
  ["AM-AG", "Aragac̣otn"],
  ["AM-AR", "Ararat"],
  ["AM-AV", "Armavir"],
  ["AM-GR", "Geġark'unik'"],
...
export const australianStates = new Map([
...
export const austrianStates = new Map([
  ["AT-1", "Burgenland"],
  ["AT-2", "Kärnten"],
...
export const bahamianDistricts = new Map([
  ["BS-AK", "Acklins"],
  ["BS-BY", "Berry Islands"],
  ["BS-BI", "Bimini"],
  ["BS-BP", "Black Point"],
...
export const barbadianParishes = new Map([
  ["BB-01", "Christ Church"],
  ["BB-02", "Saint Andrew"],
  ["BB-03", "Saint George"],
  ["BB-04", "Saint James"],
...
export const belarusianOblasts = new Map([
...
export const brazilianStates = new Map([
  ["AC", "Acre"],
  ["AL", "Alagoas"],
  ["AP", "Amapá"],
  ["AM", "Amazonas"],
...
export const canadianProvinces = new Map([
  ["AB", "Alberta"],
  ["BC", "British Columbia"],
  ["MB", "Manitoba"],
  ["NB", "New Brunswick"],
...
export const capeVerdeanMunicipalities = new Map([
  ["CV-BV", "Boa Vista"],
  ["CV-BR", "Brava"],
  ["CV-MA", "Maio"],
  ["CV-MO", "Mosteiros"],
...
export const chileanRegions = new Map([
  ["AI", "Aysén"],
  ["AN", "Antofagasta"],
...
export const chineseProvinces = new Map([
  ["AH", "Anhui"],
  ["BJ", "Beijing"],
  ["CQ", "Chongqing"],
  ["FJ", "Fujian"],
...
export const columbianDepartments = new Map([
  ["AMA", "Amazonas"],
  ["ANT", "Antioquia"],
  ["ARA", "Arauca"],
  ["ATL", "Atlántico"],
...
export const costaRicanProvinces = new Map([
  ["CR-A", "Alajuela"],
  ["CR-C", "Cartago"],
  ["CR-G", "Guanacaste"],
  ["CR-H", "Heredia"],
...
export const egyptianGovernorates = new Map([
  ["SU", "6th of October"],
  ["SHR", "Al Sharqia"],
  ["ALX", "Alexandria"],
  ["ASN", "Aswan"],
...
export const salvadoranDepartments = new Map([
  ["SV-AH", "Ahuachapán"],
  ["SV-CA", "Cabañas"],
  ["SV-CH", "Chalatenango"],
  ["SV-CU", "Cuscatlán"],
...
export const frenchRegions = new Map([
...
export const germanLands = new Map([
...
export const guatemalanDepartments = new Map([
  ["AVE", "Alta Verapaz"],
  ["BVE", "Baja Verapaz"],
  ["CMT", "Chimaltenango"],
  ["CQM", "Chiquimula"],
...
export const honduranDepartments = new Map([
  ["HN-AT", "Atlántida"],
  ["HN-CH", "Choluteca"],
  ["HN-CL", "Colón"],
  ["HN-CM", "Comayagua"],
...
export const hongKongRegions = new Map([
  ["HK", "Honk Kong Island"],
  ["KLN", "Kowloon"],
  ["NT", "New Territories"],
...
export const indonesianProvinces = new Map([
  ["AC", "Aceh"],
  ["BA", "Bali"],
  ["BT", "Banten"],
  ["BE", "Bengkulu"],
...
export const iraqiGovernorates = new Map([
  ["IQ-AN", "Al Anbār"],
  ["IQ-BA", "Al Başrah"],
  ["IQ-MU", "Al Muthanná"],
  ["IQ-QA", "Al Qādisīyah"],
...
export const irishCounties = new Map([
  ["CW", "Carlow"],
  ["CN", "Cavan"],
  ["CE", "Clare"],
  ["C", "Cork"],
...
export const italianProvinces = new Map([
  ["AG", "Agrigento"],
  ["AL", "Alessandria"],
  ["AN", "Ancona"],
  ["AO", "Aosta Valley"],
...
export const jamaicanParishes = new Map([
  ["JM-13", "Clarendon"],
  ["JM-09", "Hanover"],
  ["JM-01", "Kingston"],
  ["JM-12", "Manchester"],
...
export const japanesePrefectures = new Map([
  ["JP-01", "Hokkaido"],
  ["JP-02", "Aomori"],
  ["JP-03", "Iwate"],
  ["JP-04", "Miyagi"],
...
export const kazakhstanRegions = new Map([
...
export const kiribatianIslands = new Map([
  ["KI-G", "Gilbert Islands"],
  ["KI-L", "Line Islands"],
  ["KI-P", "Phoenix Islands"],
]);

export const malaysianStates = new Map([
  ["JHR", "Johor"],
  ["KDH", "Kedah"],
  ["KTN", "Kelantan"],
  ["MLK", "Malacca"],
...
export const mexicanStates = new Map([
  ["BCS", "Aguascalientes"],
  ["BC", "Baja California"],
...
export const mongolianProvinces = new Map([
  ["MN-073", "Arhangay"],
  ["MN-071", "Bayan-Ölgiy"],
  ["MN-069", "Bayanhongor"],
  ["MN-067", "Bulgan"],
...
export const mozambicanProvinces = new Map([
  ["MZ-P", "Cabo Delgado"],
  ["MZ-G", "Gaza"],
  ["MZ-I", "Inhambane"],
  ["MZ-B", "Manica"],
...
export const nauruanDistricts = new Map([
  ["NR-01", "Aiwo"],
  ["NR-02", "Anabar"],
  ["NR-03", "Anetan"],
  ["NR-04", "Anibare"],
...
export const newZealandProvinces = new Map([
  ["AUK", "Auckland"],
  ["BOP", "Bay of Plenty"],
  ["CAN", "Canterbury"],
  ["CIT", "Chatham Islands"],
...
export const nicaraguanDepartments = new Map([
  ["NI-BO", "Boaco"],
  ["NI-CA", "Carazo"],
  ["NI-CI", "Chinandega"],
  ["NI-CO", "Chontales"],
...
export const nigerianStates = new Map([
  ["AB", "Abia"],
  ["AD", "Adamawa"],
  ["AK", "Akwa Ibom"],
  ["AN", "Anambra"],
...
export const panamanianProvinces = new Map([
  ["PA-1", "Bocas del Toro"],
  ["PA-4", "Chiriquí"],
  ["PA-2", "Coclé"],
  ["PA-3", "Colón"],
...
export const papaNewGuineanProvinces = new Map([
  ["PG-CPM", "Central"],
  ["PG-CPK", "Chimbu"],
...
export const peruvianRegions = new Map([
  ["PE-AMA", "Amazonas"],
  ["PE-ANC", "Ancash"],
  ["PE-APU", "Apurímac"],
  ["PE-ARE", "Arequipa"],
...
export const philippineRegions = new Map([
  ["PH-ABR", "Abra"],
...
export const polishVoivodships = new Map([
  ["PL-02", "Lower Silesia"],
...
export const portugueseRegions = new Map([
  ["PT-01", "Aveiro"],
  ["PT-20", "Azores"],
  ["PT-02", "Beja"],
  ["PT-03", "Braga"],
...
export const romanianCounties = new Map([
  ["AB", "Alba"],
  ["AR", "Arad"],
  ["AG", "Argeș"],
  ["BC", "Bacău"],
...
export const russianRegions = new Map([
  ["AD", "Adygea"],
  ["AL", "Altai"],
  ["ALT", "Altai Krai"],
  ["AMU", "Amur"],
...
export const saintKittAndNevisParishes = new Map([
...
export const somalianRegions = new Map([
  ["SO-AW", "Awdal"],
  ["SO-BK", "Bakool"],
  ["SO-BN", "Banaadir"],
  ["SO-BR", "Bari"],
...
export const southAfricanProvinces = new Map([
  ["EC", "Eastern Cape"],
  ["FS", "Free State"],
  ["GP", "Gauteng"],
  ["NL", "KwaZulu-Natal"],
...
export const southKoreanProvinces = new Map([
  ["KR-26", "Busan"],
  ["KR-27", "Daegu"],
  ["KR-30", "Daejeon"],
  ["KR-42", "Gangwon"],
...
export const spanishProvinces = new Map([
  ["C", "A Coruna"],
  ["VI", "Alava"],
  ["AB", "Albacete"],
  ["A", "Alicante"],
...
export const surinameseDistricts = new Map([
  ["SR-BR", "Brokopondo"],
  ["SR-CM", "Commewijne"],
  ["SR-CR", "Coronie"],
  ["SR-MA", "Marowijne"],
...
export const swissCantons = new Map([
  ["AG", "Aargau"],
...
export const thaiProvinces = new Map([
  ["TH-37", "Amnat Charoen"],
  ["TH-15", "Ang Thong"],
  ["TH-10", "Bangkok"],
  ["TH-38", "Bueng Kan"],
...
export const turkishProvinces = new Map([
  ["TR-01", "Adana"],
  ["TR-02", "Adiyaman"],
...
export const tuvaluanIslands = new Map([
  ["TV-NMG", "Nanumaga"],
  ["TV-NMA", "Nanumea"],
  ["TV-NIT", "Niutao"],
  ["TV-NUI", "Nui"],
...
export const ukrainianRegions = new Map([
...
export const uaeEmirates = new Map([
  ["AZ", "Abu Dhabi"],
  ["AJ", "Ajman"],
  ["FU", "Fujairah"],
  ["SH", "Sharjah"],
...
export const usaStates = new Map([
  ["AL", "Alabama"],
  ["AK", "Alaska"],
  ["AS", "American Samoa"],
  ["AZ", "Arizona"],
...
export const uruguayanDepartments = new Map([
  ["UY-AR", "Artigas"],
  ["UY-CA", "Canelones"],
  ["UY-CL", "Cerro Largo"],
  ["UY-CO", "Colonia"],
...
export const uzbekRegions = new Map([
  ["UZ-AN", "Andijon"],
  ["UZ-BU", "Buxoro"],
  ["UZ-FA", "Farg`ona"],
  ["UZ-JI", "Jizzax"],
...
export const venezuelanStates = new Map([
  ["VE-Z", "Amazonas"],
  ["VE-B", "Anzoátegui"],
  ["VE-C", "Apure"],
  ["VE-D", "Aragua"],
...
export const vietnameseProvinces = new Map([
  ["VN-44", "An Giang"],
...
export const firstAdministrativeLevels = new Map([
